...
const endpoint = 'https://www.quicknode.com/endpoints/145317'; //Replace with your RPC Endpoint
...
fs.writeFile('mint-fungible-spl/guideSecret.json', secret, 'utf8', function(err) {
    if (err) throw err;
